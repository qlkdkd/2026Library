...
url_dict = {
    ...
    '인개대출도서 조회':'https://data4library.kr/api/loanItemSrch',
...
# api url에 접근 후, 해당 xml을 데이터프레임으로 변환하는 함수
def read_xml(params):
...
if __name__ == "__main__":
    ...
    # api url 접근용 딕셔너리
    params = {
    'authKey': '_______________________________________',  # 도서관정보나루에서 발급받은 Key
    'startDt': '2026-05-01',
    'endDt': '2026-05-31',
    'pageNo': '1',
    'pageSize': '10'
